 ...
 * @LastEditTime: 2021-08-09 03:55:07
 * @FilePath: \supermall\mushroom_mall\src\views\profile\childComps\UserInfo.vue
-->
<template>
  <div id="user-info">
    <a href="#" class="clear-fix">
      <slot name="user-icon">
        ...
        <img src="~assets/img/common/kobe.gif" alt="" class="privateImage-svg left">
      </slot>
